...
import saumya.com.instagramclone2.materialcamera.util.Degrees;
import saumya.com.instagramclone2.materialcamera.util.ImageUtil;
import saumya.com.instagramclone2.materialcamera.util.ManufacturerUtil;

import static saumya.com.instagramclone2.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static saumya.com.instagramclone2.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static saumya.com.instagramclone2.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static saumya.com.instagramclone2.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static saumya.com.instagramclone2.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static saumya.com.instagramclone2.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  saumya.com.instagramclone2.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new saumya.com.instagramclone2.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof saumya.com.instagramclone2.materialcamera.internal.CameraPreview)
